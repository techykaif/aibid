...
- **2026-09-11 04:08 IST:** the existing workflow remains configured to run TypeScript, ESLint, production build, public production smoke with three retries, SEO-boundary smoke, AI-category smoke, and a final failure when public smoke fails.
- **2026-09-11 04:08 IST:** source/spec audit rechecked `AGENTS.md`, PRD v3, PRD v3.1, implementation status, recent main commits, and the active AI-only taxonomy. No newer product-spec document was identified. The seven authoritative AI slugs are `coding`, `writing`, `image`, `video`, `agents`, `productivity`, and `other`; Games/Open Source/Music remain future-only.
