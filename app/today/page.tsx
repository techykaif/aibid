...
export default async function Today() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Today’s AI market", item: "https://www.ai-bid.lol/today" },
    ],
  };
  const listSchema = items.length > 0 ? {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Today’s AI market",
